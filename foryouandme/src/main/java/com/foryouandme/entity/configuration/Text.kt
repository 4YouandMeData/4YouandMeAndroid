...
data class Tab(
    ...
    val feedHeaderSubTitlePhase2: String?,
    ...
    companion object {
        ...
        fun mock(): Tab =
            Tab(
                ...
                feedHeaderSubTitlePhase2 = Mock.title,
...
data class StudyInfo(
    val aboutYou: String,
    val dueDateExtra: String?,
    val deliveryDateExtra: String?,
) {
    ...
    companion object {
        ...
        fun mock(): StudyInfo =
            StudyInfo(
                ...
                dueDateExtra = Mock.body,
                deliveryDateExtra = Mock.body
            )
