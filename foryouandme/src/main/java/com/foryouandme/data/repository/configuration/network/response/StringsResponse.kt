...
data class StringsResponse(
    ...
    @Json(name = "VIDEO_DIARY_RECORDER_INFO_FILTER") val videoDiaryRecorderInfoFilter: String? = null,
    ...
    private fun toVideoDiary(): VideoDiary? =
        when (null) {
            ...
            videoDiaryRecorderInfoFilter, videoDiaryRecorderTitle, videoDiaryRecorderCloseButton,
            videoDiaryRecorderReviewButton, videoDiaryRecorderSubmitButton, videoDiarySuccessTitle,
            videoDiaryDiscardTitle, videoDiaryDiscardBody, videoDiaryDiscardCancel, videoDiaryDiscardConfirm,
