...
class ReactionTimeTask(
    ...
    override val steps: List<Step> by lazy {
        ...
        listOf(
            ...
            EndStep(
                ...
                description = {
                    endDescription ?: it.getString(R.string.REACTION_TIM_end_description)
                },
    ...
    companion object {
        ...
        const val REACTION_TIME_BLOCK = "reaction_time_block"
        ...
        fun getReactionTimeCoreSteps(
            ...
            listOf(
                IntroductionStep(
                    ...
                    block = Block(REACTION_TIME_BLOCK, stepColor),
